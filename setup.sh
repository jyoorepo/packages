...
echo -e "${RED}==========================================================================${NC}";
echo -e "version 1.2.7 - Copyright (C) 2014-2023 Trudesk Inc.";
echo -e "";
...
case $response in
[yY]*)
  start_spinner "${YELLOW}Installing MongoDB 6.0${NC}"
...
*)
  ...
  wget https://repo.mongodb.org/apt/ubuntu/dists/focal/mongodb-org/6.0/multiverse/binary-arm64/mongodb-org-database-tools-extra_6.0.6_arm64.deb > /dev/null 2>&1;
  dpkg -i mongodb-org-database-tools-extra_6.0.6_arm64.deb > /dev/null;
  rm -rf mongodb-org-database-tools-extra_6.0.6_arm64.deb
  stop_spinner $?
  ;;
esac
...
git checkout v1.2.7 > /dev/null 2>&1;
